...
public class GatewayContract {
    ...
    public GatewayContract(Credentials credentials, Blockchain blockchain) {
        ...
        mGateway = Gateway.load(
                ...
                web3j, credentials, new DefaultGasProvider() // TODO: fix gas limit
        );
    ...
    public WalletContract getWalletContract(Address address, String uid, Credentials credentials) {
        return new WalletContract(address, mBlockchain, credentials, uid, this);
    }
}
